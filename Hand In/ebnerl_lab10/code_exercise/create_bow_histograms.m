function vBoW = create_bow_histograms(nameDir, vCenters)
  ...
  for i=1:nImgs
    ...
    vPoints = grid_points(img, nPointsX, nPointsY, border);  % get grid points
    [vFeatures, ~] = descriptors_hog(img, vPoints, cellWidth, cellHeight);  % get descriptors of grid points points
